            ...
            <div className={cardClassName}>
              ...
              {section === "view" && (
                ...
                >
                  {!isLoggedIn && (
                    <div
                      className="rounded-2xl border border-primary/35 bg-primary/[0.04] p-4"
                      data-tutorial-id="profile-auth"
                    >
                      <div className="flex items-start gap-3">
                        <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-primary/30 bg-primary/[0.08]">
                        ...
                        <div className="min-w-0 flex-1 space-y-2">
                          <button
                            ...
                            className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-2.5 text-sm font-semibold text-primary-foreground transition hover:bg-primary/90 touch-manipulation"
                          >
                            <LogIn className="h-4 w-4 shrink-0" />
                            Войти / Зарегистрироваться
                          </button>
                          <p className="text-xs leading-relaxed text-muted-foreground">
                            Чтобы сохранять карты, контакты, историю диалогов и покупки на всех устройствах
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="relative shrink-0">
                      ...
                      <button
                        ...
                        className="absolute -bottom-0.5 -right-0.5 flex h-8 w-8 items-center justify-center rounded-full border-2 border-background bg-card text-primary shadow-md transition hover:bg-primary/15 touch-manipulation"
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {zodiac && <p className="text-sm font-medium text-primary">{zodiac}</p>}
                      ...
                      {profile?.isUnlimited && (
                        <p className="mt-0.5 text-xs text-emerald-400">Безлимитный доступ активен</p>
                      )}
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-xl border border-primary/30 bg-primary/15 py-2.5 text-sm font-medium text-primary transition-all hover:bg-primary/25"
                  >
                  ...
                  {isLoggedIn && (
                    <div className="space-y-2 border-t border-border/40 pt-3">
                      ...
                      <button
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-xl border border-destructive/30 py-2 text-sm font-medium text-destructive transition hover:bg-destructive/10"
                      >
              ...
              {section === "memories" && (
                ...
                >
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Сюда попадают короткие факты из диалога (имя, город, важные события, переживания), которые
                    ты сам упоминаешь в сообщениях — не каждый ответ астролога. Можно удалить любую запись.
                  </p>
