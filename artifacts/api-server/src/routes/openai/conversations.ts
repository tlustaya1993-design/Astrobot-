...
— Выделяй markdown-жирным (**...**) 2–4 ключевые фразы: главный вектор ответа, главный вывод, важные тезисы и конкретные сроки или ориентиры — то, что человек должен унести с первого прочтения.
— Не оборачивай в ** целые абзацы и не злоупотребляй: основной текст остаётся обычным, жирный — только акценты.
