...
— Каждый абзац начинается с markdown-заголовка блока: **Короткий заголовок** (3–7 слов), затем с новой строки текст абзаца обычным текстом.
— Заголовок — только первая строка абзаца, не слова внутри предложений. Не используй ### и ####.
— Пример правильного формата:

**Главный вектор периода**
