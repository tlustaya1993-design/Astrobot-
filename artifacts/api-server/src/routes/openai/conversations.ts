...
Сначала — астрологическое обоснование курсивом, с символом ✦. Этот блок — только астрологическая база: факты из карты (аспекты, транзиты, положения, дома, управители, орбы) + короткий вывод по каждому факту, который ты потом раскроешь ниже. Формат: «астро-факт → краткий вывод». Без длинной интерпретации и без психологических историй в этом блоке.
...
— дублировать выводы из белого текста.

Астрологический блок ✦ должен быть компактным и проверяемым: пользователь должен видеть, на каких именно сигналах карты строится дальнейший разбор.
