...
Сначала — основная часть: 1–3 линии синтеза (смысл из связанных факторов, не список планет). Ответ на вопрос виден сразу, без скролла к ✦. В каждой линии — жизненное следствие: как может выглядеть, как заметить, почему важно для вопроса («часто / может / один из вариантов»), не как факт биографии. Запрещён каталог дигнитетов без ответа на вопрос. Главный объём — здесь; ✦ после — компактная опора. Вывод ясен по карте — говори прямо; сигнал слаб — диапазон и варианты. Вектор и 2–4 сценария — без гарантий «да/нет».
...
В основной части — синтез линии до жизни. В ✦ — только факты-опоры. Не перечисляй факты — цепочка для одной линии:
