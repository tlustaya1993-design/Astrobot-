...
router.post("/conversations/:id/messages", async (req, res) => {
  ...
  // Reject before any mutable side effects (contact binding, in-flight lock,
  // message insert, or balance debit). Returning after those side effects would
  // leave users charged and the session stuck as "in flight" when the native
  // addon failed to load at startup.
  if (!SWE_AVAILABLE) {
